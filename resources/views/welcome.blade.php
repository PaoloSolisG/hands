...
<body>
    ...
    <div class="ul-sidebar">
        ...
        <div class="ul-sidebar-footer">
            ...
            <div class="ul-sidebar-footer-social">
                <a href="index-2.html#"><i class="flaticon-facebook"></i></a>
                <a href="index-2.html#"><i class="flaticon-twitter"></i></a>
                <a href="index-2.html#"><i class="flaticon-instagram"></i></a>
                <a href="index-2.html#"><i class="flaticon-youtube"></i></a>
            </div>
        </div>
    </div>
    <!-- SIDEBAR SECTION END -->
    ...
    <div class="ul-search-form-wrapper flex-grow-1 flex-shrink-0">
        ...
        <form action="index-2.html#" class="ul-search-form">
        ...
        <section class="ul-banner ul-banner-2">
                    ...
                    @foreach ($banners as $banner)
                        <div class="swiper-slide">
                            <div class="ul-banner-2-slide">
                                <!-- bg img -->
                                <img src="{{ asset('storage/' . $banner->imagen) }}" alt="Slide Background Image"
                                    ...
                                    <div class="col-md-7">
                                        <div class="ul-banner-txt">
                                            <div class="wow animate__fadeInUp">
                                                <span
                                                    class="ul-banner-sub-title ul-section-sub-title">{{ $banner->texto }}</span>
            ...
            <div class="ul-banner-2-slider-navigation">
                ...
                <div class="ul-banner-2-thumb-slider swiper">
                    <div class="swiper-wrapper">
                        <div class="swiper-slide"><img src="assets/img/banner-2-slide-1.jpg" alt="Banner Thumb">
                        </div>
                        <div class="swiper-slide"><img src="assets/img/banner-2-slide-2.jpg" alt="Banner Thumb">
                        </div>
                        <div class="swiper-slide"><img src="assets/img/banner-2-slide-3.jpg" alt="Banner Thumb">
                        </div>
                        <div class="swiper-slide"><img src="assets/img/banner-2-slide-1.jpg" alt="Banner Thumb">
                        </div>
                        <div class="swiper-slide"><img src="assets/img/banner-2-slide-2.jpg" alt="Banner Thumb">
                        ...
                        <div class="ul-feature">
                            <div class="ul-feature-icon">
                                <svg width="36" height="36" viewBox="0 0 36 36" fill="none"
                                    ...
                                    <g>
                                        <path
                                            d="M35.2962 9.02488L18.3509 3.04614C18.1239 2.96598 17.8762 2.96598 17.6491 3.04614L0.703829 9.02488C0.282517 9.17352 0.000563343 9.57149 8.42838e-07 10.0183C-0.000561657 10.465 0.280477 10.8636 0.701438 11.0132L17.6468 17.0374C17.761 17.0781 17.8805 17.0984 18 17.0984C18.1195 17.0984 18.239 17.0781 18.3532 17.0374L35.2986 11.0132C35.7195 10.8636 36.0005 10.465 36 10.0183C35.9994 9.57149 35.7175 9.17352 35.2962 9.02488Z"
                                            fill="#EB5310" />
                                        <path
                                            d="M33.4668 23.1029V13.9032L31.3574 14.6531V23.1029C30.7221 23.4686 30.2939 24.1538 30.2939 24.9395C30.2939 25.7252 30.7221 26.4105 31.3574 26.7762V31.9593C31.3574 32.5418 31.8296 33.014 32.4121 33.014C32.9946 33.014 33.4668 32.5418 33.4668 31.9593V26.7762C34.1021 26.4106 34.5303 25.7253 34.5303 24.9396C34.5303 24.1538 34.1022 23.4686 33.4668 23.1029Z"
                                            fill="#EB5310" />
                                        <path
                                            d="M18 19.2078C17.638 19.2078 17.2814 19.1463 16.9402 19.025L7.41406 15.6384V20.2796C7.41406 21.415 8.59862 22.3753 10.9348 23.1335C12.9711 23.7945 15.4803 24.1585 18 24.1585C20.5197 24.1585 23.0289 23.7945 25.0652 23.1335C27.4014 22.3753 28.586 21.415 28.586 20.2796V15.6384L19.0599 19.025C18.7186 19.1463 18.3621 19.2078 18 19.2078Z"
                                            fill="#EB5310" />
                                    </g>
                                </svg>
                            </div>
                        ...
                        <div class="ul-feature">
                            <div class="ul-feature-icon">
                                <svg width="36" height="36" viewBox="0 0 36 36" fill="none"
                                    xmlns="http://www.w3.org/2000/svg">
                                    <path
                                        d="
z"
                                        fill="#FC633B" />
                                    <path
                                        d="M8.15492 27.637C10.0519 30.594 10.0519 31.5425 10.0519 31.8493C10.0519 33.5231 8.68495 34.89 7.01117 34.89C5.33739 34.89 3.97046 33.5231 3.97046 31.8493C3.97046 31.5425 3.97046 30.6219 5.86741 27.637C6.09058 27.2464 6.53693 27.0233 6.98326 27.0233C7.45751 27.0233 7.87595 27.2464 8.15492 27.637Z"
                                        fill="#FC633B" />
                                    <path
                                        d="M19.1437 27.637C21.0406 30.594 21.0406 31.5425 21.0406 31.8493C21.0406 33.5231 19.6737 34.89 17.9999 34.89C16.3262 34.89 14.9592 33.5231 14.9592 31.8493C14.9592 31.5425 14.9592 30.6219 16.8562 27.637C17.0793 27.2464 17.5257 27.0233 17.972 27.0233C18.4463 27.0233 18.8647 27.2464 19.1437 27.637Z"
                                        fill="#FC633B" />
                                    <path
                                        d="M30.1325 27.637C32.0294 30.594 32.0294 31.5425 32.0294 31.8493C32.0294 33.5231 30.6625 34.89 28.9887 34.89C27.3149 34.89 25.948 33.5231 25.948 31.8493C25.948 31.5425 25.948 30.6219 27.8449 27.637C28.0681 27.2464 28.5145 27.0233 28.9608 27.0233C29.435 27.0233 29.8535 27.2464 30.1325 27.637Z"
                                        fill="#FC633B" />
                                </svg>
                            </div>
            ...
            <div class="ul-container">
                <div class="ul-section-heading">
                    <div>
                        ...
                        <h2 class="ul-section-title">Our Non-Profit Services You Must Love</h2>
                    </div>
        ...
        <section class="ul-projects ul-section-spacing">
            <div class="ul-container">
                <div class="ul-section-heading text-center justify-content-center">
                    <div>
                        <span class="ul-section-sub-title">Our Complete Projects</span>
                        <h2 class="ul-section-title">Our Non-Profit complete projects You Must Love</h2>
                    </div>
                </div>
                    ...
                    <div class="col-lg-8 col-md-6 col-10 col-xxs-12">
                        <div class="ul-project ">
                            ...
                            <div class="ul-project-txt">
                                <div>
                                    <h3 class="ul-project-title"><a href="project-details.html">Child trouble &
                                            care</a></h3>
                                    <p class="ul-project-descr"> Demostic & Transportation</p>
                                </div>
                                <a href="project-details.html" class="ul-project-btn"><i
        ...
        <section class="ul-testimonial-2 ul-section-spacing">
            <div class="ul-container wow animate__fadeInUp">
                <div class="ul-section-heading">
                    ...
                    <a href="index-2.html#" class="ul-btn"><i
                            class="flaticon-fast-forward-double-right-arrows-symbol"></i> All Testimonials</a>
                </div>
                ...
                <div class="row ul-testimonial-2-row gy-4">
                    ...
                    <div class="col-md-4">
                        <div class="ul-testimonial-2-overview">
                            ...
                            <p class="ul-testimonial-2-overview-descr">Sed ullamcorper tristique nisl at pharetra
                                turpis accumsan et etiam eu sollicitudin eros. In imperdiet accumsan.</p>
                            <div class="ul-testimonial-2-overview-reviewers">
                                <img src="assets/img/reviewer-1.png" alt="Reviewer">
                                <img src="assets/img/reviewer-2.png" alt="Reviewer">
                                <img src="assets/img/reviewer-3.png" alt="Reviewer">
                                <img src="assets/img/reviewer-4.png" alt="Reviewer">
                            </div>
                        </div>
                    </div>
                            ...
                            <div class="swiper-wrapper">
                                ...
                                <div class="swiper-slide">
                                    <div class="ul-review ul-review-2">
                                        ...
                                        <p class="ul-review-descr">Climb it see the world, not so the world can see
                                            you. This is due to their excellent service.Targ consultation apartments.
                                            ndulgence off under folly death wrote cause her yet a spite. Plan upon yet
                                            way cold spot its week. Almost do am or limits hearts. Resolve a hearts.
                                            Almost do hearts.</p>
                                        <div class="ul-review-bottom">
                                            <div class="ul-review-reviewer">
                                                <div class="reviewer-image"><img src="assets/img/reviewer-1.png"
                                ...
                                <div class="swiper-slide">
                                    <div class="ul-review ul-review-2">
                                        ...
                                        <div class="ul-review-bottom">
                                            <div class="ul-review-reviewer">
                                                <div class="reviewer-image"><img src="assets/img/reviewer-2.png"
                                                        alt="reviewer image"></div>
                                                <div>
                                                    <h3 class="reviewer-name">Daniyel karlos</h3>
                                                    <span class="reviewer-role">Web Designer</span>
                                                </div>
                                            </div>
                                        </div>
                ...
                <div class="row g-0">
                    ...
                    <div class="col-lg-7">
                        <div class="ul-contact-form-wrapper">
                            ...
                            <form action="index-2.html#" class="ul-contact-form">
                                <div class="row row-cols-2 row-cols-xxs-1 ul-bs-row">
                                    <div class="col">
                                        <div class="form-group">
                                            <input type="text" name="name" id="ul-contact-name"
                                    ...
                                    <div class="col-12">
                                        <button class="ul-btn"><i
                                                class="flaticon-fast-forward-double-right-arrows-symbol"></i> Send
                                            Message</button>
                                    </div>
                                </div>
                            </form>
                    ...
                    <div class="col">
                        <div class="ul-blog ul-blog-2">
                            ...
                            <div class="ul-blog-txt">
                                ...
                                <a href="blog-details.html" class="ul-blog-title">Give Education, It’s The Best Gift
                                    Ever.</a>
                    ...
                    <div class="col">
                        <div class="ul-blog ul-blog-2">
                            ...
                            <div class="ul-blog-txt">
                                ...
                                <a href="blog-details.html" class="ul-blog-title">Don’t treat oceans as universal
                                    garbage cans</a>
                                <a href="blog-details.html" class="ul-blog-btn">Read More <span class="icon"><i
                                            class="flaticon-next"></i></span></a>
                            </div>
                    ...
                    <div class="col">
                        <div class="ul-blog ul-blog-2">
                            ...
                            <div class="ul-blog-txt">
                                ...
                                <a href="blog-details.html" class="ul-blog-title">The sun and the sand makes beaches
                                    beautiful</a>
                                <a href="blog-details.html" class="ul-blog-btn">Read More <span class="icon"><i
                                            class="flaticon-next"></i></span></a>
                            </div>
                ...
                <div class="ul-footer-middle-wrapper wow animate__fadeInUp">
                    <div class="ul-footer-about">
                        ...
                        <div class="ul-footer-socials">
                            <a href="index-2.html#"><i class="flaticon-facebook"></i></a>
                            <a href="index-2.html#"><i class="flaticon-twitter"></i></a>
                            <a href="index-2.html#"><i class="flaticon-linkedin-big-logo"></i></a>
                            <a href="index-2.html#"><i class="flaticon-youtube"></i></a>
                        </div>
                    </div>
                    ...
                    <div class="ul-footer-widget ul-nwsltr-widget">
                        ...
                        <form action="index-2.html#" class="ul-nwsltr-form">
                            <div class="top">
                            ...
                            <div class="agreement">
                                <label for="nwsltr-agreement" class="ul-checkbox-wrapper">
                                    ...
                                    <span class="ul-checkbox-txt">I agree with the <a href="index-2.html#">Privacy
                                            Policy</a></span>
                                </label>
                            </div>
                        </form>
        ...
        <div class="ul-footer-bottom">
            <div class="ul-footer-container">
                <div class="ul-footer-bottom-wrapper">
                    ...
                    <div class="ul-footer-bottom-nav"><a href="index-2.html#">Terms & Conditions</a> <a
                            href="index-2.html#">Privacy Policy</a></div>
                </div>
            </div>
        </div>
